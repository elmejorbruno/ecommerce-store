...
import ShopBag from "../../assets/icon/bag-dark-blue-circulo-blue-light.svg"
        ...
        <div className="flex justify-center items-center"> 
            <ul className="sm:flex hidden  items-center gap-4 py-3">
               ...
               <li className="group relative cursor-pointer">
                <a href="#"
                 className="flex items-center fap-[2px] py-2">
                    Treading Items
                    <span>
                        <FaCaretDown className="transition-all duration-200 group-hover:rotate-180"/>
                    </span>
                </a>
                <div className="absolute z-[999] hidden group-hover:block w-[150px] rounded-md bg-white dark:bg-gray-900 shadow-md ">
                    <ul className="absolute bg-white dark:bg-gray-900 shadow-md rounded-md py-2 px-4 mt-2">
                        {DropdownLinks.map((data) => (
                            <li key={data.id} className="">
                                <a href={data.link} className="inline-block w-full rounded-md p-2 hover:bg-gray-200 dark:hover:bg-gray-700 ">
                                    {data.name}
                                </a>
                            </li>
                        ))
