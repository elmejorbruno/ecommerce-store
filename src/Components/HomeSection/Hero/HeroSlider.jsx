	...
	return (
		<>
			{ImageList.map((data, index) => (
				<div key={data.id} className={`${index === currentSlider ? 'block' : 'hidden'}` }>
					<div className="grid grid-cols-1  sm:grid-cols-2 border-amber-100 ">
						{/* Texto */}
						<div
							className="flex flex-col justify-center gap-4 pt-2 sm:pt-0 text-center sm:text-left
          ...
          shadow font-bold"
				...
				<button
					className="w-10 h-10 rounded-b-full bg-white
